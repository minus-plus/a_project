...
rawTestData = samples.loadDataFile("facedata/facedatatest", numTestF,FACE_DATUM_WIDTH,FACE_DATUM_HEIGHT)
featureFunction = dataClassifier.enhancedFeatureExtractorFace
testLabels = samples.loadLabelsFile("facedata/facedatatestlabels", numTestF)
...
rawTestData = samples.loadDataFile("digitdata/testimages", numTestD,DIGIT_DATUM_WIDTH,DIGIT_DATUM_HEIGHT)
featureFunction = dataClassifier.enhancedFeatureExtractorDigit
testLabels = samples.loadLabelsFile("digitdata/testlabels", numTestD)
testData = map(featureFunction, rawTestData)
